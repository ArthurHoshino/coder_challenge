...
class InterfaceRegistro(ttk.Frame):
    ...
    def show(self):
        ...
        self.tamanhoLabel.grid(row=0, column=0, padx=10, pady=20, sticky='nsew')
        self.tamanho.grid(row=0, column=1, padx=10, pady=20, sticky='nsew')
        self.corLabel.grid(row=1, column=0, padx=10, pady=20, sticky='nsew')
        self.cor.grid(row=1, column=1, padx=10, pady=20, sticky='nsew')
        self.localLabel.grid(row=2, column=0, padx=10, pady=20, sticky='nsew')
        self.local.grid(row=2, column=1, padx=10, pady=20, sticky='nsew')
        self.poderLabel.grid(row=3, column=0, padx=10, pady=20, sticky='nsew')
        self.poder.grid(row=3, column=1, padx=10, pady=20, sticky='nsew')

        self.armamentoLabel.grid(row=4, column=0, padx=10, pady=20, sticky='nsew', rowspan=2)
        self.armamento.grid(row=4, column=1, padx=10, pady=20, sticky='nsew', rowspan=2)
        ...
        self.buttomVoltar.grid(row=6, column=0, padx=20, pady=20, sticky='nsew', columnspan=2)
        self.buttom.grid(row=6, column=2, padx=20, pady=20, sticky='nsew', columnspan=2)
